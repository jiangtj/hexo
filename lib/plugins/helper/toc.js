...
const { tocObj, escapeHTML, encodeURL, Cache } = require('hexo-util');
...
function tocHelper(str, options = {}) {
  ...
  console.log(this.page.full_source);
  const aaa = cache.get(this.page.full_source);
  if (aaa) console.log(aaa);
  console.log(this.page.source);
  const bbb = cache.get(this.page.source);
  if (bbb) console.log(bbb);
...
module.exports = {tocHelper, cache};
